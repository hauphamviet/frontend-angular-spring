...
export class UserService {
    ...
    changePassword(username: string, oldPassword: string, newPassword: string, comfirmPassword: string):Observable<any> {
        return this.http.put(USER_API + 'password', {username, oldPassword, newPassword, comfirmPassword}, httpOptions);
    }
